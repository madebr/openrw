...
class OpenrwConan(ConanFile):
    ...
    description = '''OpenRW 'Open ReWrite' is an unofficial open source recreation of the classic Grand Theft Auto III game executable'''
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        pic = self.options.python
        if self.settings.compiler == 'Visual Studio':
            pic |= self.settings.fPIC
        defs = {
